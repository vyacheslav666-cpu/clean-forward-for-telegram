...
export class UploadPreviewAdapter {
  ...
  public async cancelActivePreview(): Promise<boolean> {
    ...
    // reason only sends that were not already running count: one stuck since an offline session
    // is not this preview's doing, and reporting it stops the batch for safety.
