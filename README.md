...
Текущий релиз — `0.1.11`; версия показывается не только в userscript header и
`manifest.json`, но и в заголовках picker/progress UI. Если там нет `v0.1.11`,
новый runtime не запущен.
