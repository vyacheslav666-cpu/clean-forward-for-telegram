...
- выбор одного получателя из уже загруженных диалогов;
...
- мультивыбор получателей не поддерживается;
...
- `src/recipient/` содержит модель получателя и логику single-select picker;
